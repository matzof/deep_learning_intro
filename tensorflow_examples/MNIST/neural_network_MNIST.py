...
h1 = 256               # number of nodes in the 1st hidden layer
h2 = 256               # number of nodes in the 2nd hidden layer
...
# Create a fully-connected layer with h2 nodes as hidden layer
